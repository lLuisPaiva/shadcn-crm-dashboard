...
export const translations: Record<Language, Translations> = {
    ...
    pricing: {
      ...
      tiers: {
        migration: {
          ...
          price: "$49/month",
          description: "Browser extension that automatically fills forms and extracts data from web pages.",
          features: [
        ...
        complete: {
          ...
          price: "From $5,000",
          description: "Complete platform with total integration into your systems and intelligent dashboards.",
          features: [
            "Intelligent dashboard with chat interface",
            "Integration with CRM, email, databases",
            "Natural language commands (text/voice)",
            "Automated complex task execution",
            "Priority technical support (6 months)",
          ],
          cta: "Request Quote",
        },
        enterprise: {
          ...
          price: "Custom Price",
          description: "Full-scale integration with custom AI, dedicated team, and SLA guarantees.",
          features: [
            "Everything in Complete Platform",
            "Custom integration for all company systems",
            "Advanced multi-platform AI",
            "Dedicated support team",
            "SLA guarantees & custom development",
  ...
  pt: {
    ...
    pricing: {
      ...
      tiers: {
        migration: {
          name: "Extensão Browser",
          price: "49€/mês",
          description: "Extensão do browser que preenche formulários automaticamente e extrai dados de páginas web.",
          features: [
        ...
        complete: {
          name: "Plataforma Completa Typeble",
          price: "A partir de 5.000€",
          description: "Plataforma completa com integração total nos seus sistemas e dashboards inteligentes.",
          features: [
            "Dashboard inteligente com chat",
            "Integração com CRM, email, bases de dados",
            "Comandos em linguagem natural (texto/voz)",
            "Execução automática de tarefas complexas",
            "Suporte técnico prioritário (6 meses)",
          ],
        ...
        enterprise: {
          ...
          description: "Integração completa com IA customizada, equipa dedicada e garantias SLA.",
          features: [
            "Tudo incluído na Plataforma Completa",
            "Integração customizada para todos os sistemas",
            "IA avançada multi-plataforma",
            "Equipa de suporte dedicada",
            "Garantias SLA e desenvolvimento personalizado",
  ...
  da: {
    ...
    pricing: {
      ...
      tiers: {
        migration: {
          name: "Browserudvidelse",
          price: "49$/måned",
          description: "Browserudvidelse der automatisk udfylder formularer og udtrækker data fra websider.",
          features: [
            "Browserudvidelse til Chrome/Edge",
            "Automatisk formularudfyldning",
            "Dataudtrækning fra websider",
            "E-mail support",
          ],
          cta: "Kom I Gang",
        },
        complete: {
          ...
          price: "Fra $5.000",
          description: "Komplet platform med total integration i dine systemer og intelligente dashboards.",
          features: [
            "Intelligent dashboard med chat-grænseflade",
            "Integration med CRM, e-mail, databaser",
            "Kommandoer på naturligt sprog (tekst/stemme)",
            "Automatiseret kompleks opgaveudførelse",
            "Prioriteret teknisk support (6 måneder)",
          ],
          cta: "Anmod Om Tilbud",
        },
        enterprise: {
          ...
          description: "Fuldskala integration med tilpasset AI, dedikeret team og SLA-garantier.",
          features: [
            "Alt inkluderet i Komplet Platform",
            "Tilpasset integration for alle virksomhedssystemer",
            "Avanceret multi-platform AI",
            "Dedikeret supportteam",
            "SLA-garantier og tilpasset udvikling",
